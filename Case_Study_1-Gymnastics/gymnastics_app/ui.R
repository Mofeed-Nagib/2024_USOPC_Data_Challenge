                        ...
                        sidebarLayout(
                          ...
                          mainPanel(
                            ...
                            wellPanel(
                              ...
                              # explanatory text
                              h3("Team Results"),
                              p("The table below shows the average weighted medal count across our simulations. Click on a team to see more detailed results below."),
      ...
      tabPanel("Women's Team",
               ...
               sidebarLayout(
                 ...
                 sidebarPanel(
                   ...
                   # gold weight input
                   numericInput("gold_female_weight",
                                "Select a weight for gold medals:",
                                value = 3,
                                min = 0), # close gold input
                   
                   # silver weight input
                   numericInput("silver_female_weight",
                                "Select a weight for silver medals:",
                                value = 2,
                                min = 0), # close silver input
                   
                   # bronze weight input
                   numericInput("bronze_female_weight",
                                "Select a weight for bronze medals:",
                                value = 1,
                                min = 0) # close bronze input
                   ), # close sidebar panel
